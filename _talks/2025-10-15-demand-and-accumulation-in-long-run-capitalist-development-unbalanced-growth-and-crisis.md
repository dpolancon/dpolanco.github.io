---
title: "Demand and Accumulation in Long-Run Capitalist Development: Unbalanced Growth and Crisis"
collection: talks
layout: talk
type: "Workshop presentation"
date: 2025-10-15
venue: "Graduate Student Workshop (First Session, Fall 2025)"
host: "Department of Economics, University of Massachusetts Amherst"
location: "Amherst, MA, USA"

# Use many_slides if you want multiple buttons; otherwise delete this block
many_slides:
  - label: "Slides (PDF)"
    url: "/files/JobMarketPaper_Talk.pdf"

# If you only have one slide deck and your layout falls back to 'slides', you can keep this too
# slides: "/files/JobMarketPaper_Talk.pdf"
...
*Note: Presented at the UMass Graduate Student Workshop (First Session, Fall 2025).*
